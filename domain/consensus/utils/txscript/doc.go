/*
Package txscript implements the sedra transaction script language.

This package provides data structures and functions to parse and execute
sedra transaction scripts.

# Script Overview

sedra transaction scripts are written in a stack-base, FORTH-like language.

The sedra script language consists of a number of opcodes which fall into
...
Typical sedra scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend sedra.
