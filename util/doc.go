/*
Package util provides sedra-specific convenience functions and types.

# Block Overview

A Block defines a sedra block that provides easier and more efficient
...
A Tx defines a sedra transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a sedra address. While the
most common type is a pay-to-pubkey, sedra already supports others and
...
To decode/encode an address:
	...
	addrString := "sedra:qqj9fg59mptxkr9j0y53j5mwurcmda5mtza9n6v9pm9uj8h0wgk6uma5pvumr"
	defaultPrefix := util.Bech32PrefixSedra
