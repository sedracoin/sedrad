...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := sedrad.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = sedrad.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = sedrad.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
