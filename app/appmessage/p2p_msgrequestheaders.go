...
// MsgRequestHeaders implements the Message interface and represents a sedra
...
// NewMsgRequstHeaders returns a new sedra RequestHeaders message that conforms to the
