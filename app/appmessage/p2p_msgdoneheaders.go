...
// MsgDoneHeaders implements the Message interface and represents a sedra
...
// NewMsgDoneHeaders returns a new sedra DoneIBDBlocks message that conforms to the
// Message interface.
