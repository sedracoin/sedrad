...
// MsgRequestRelayBlocks implements the Message interface and represents a sedra
...
// NewMsgRequestRelayBlocks returns a new sedra RequestRelayBlocks message that conforms to
