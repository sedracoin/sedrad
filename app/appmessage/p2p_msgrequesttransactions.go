...
// MsgRequestTransactions implements the Message interface and represents a sedra
...
// NewMsgRequestTransactions returns a new sedra RequestTransactions message that conforms to
