...
// MsgRequestAnticone implements the Message interface and represents a sedra
...
// NewMsgRequestAnticone returns a new sedra RequestPastDiff message that conforms to the
