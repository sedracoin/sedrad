...
// MsgRequestNextHeaders implements the Message interface and represents a sedra
...
// NewMsgRequestNextHeaders returns a new sedra RequestNextHeaders message that conforms to the
// Message interface.
