...
// MsgTransactionNotFound defines a sedra TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new sedra transactionsnotfound message that conforms to the
