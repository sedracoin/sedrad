...
// RPCTransaction is a sedrad transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a sedrad transaction input representation
...
// RPCScriptPublicKey is a sedrad ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a sedrad transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a sedrad outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a sedrad utxo entry representation meant to be used
// over RPC
