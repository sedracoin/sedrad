...
// installService attempts to install the Sedrad Service. Typically this should
...
// removeService attempts to uninstall the Sedrad Service. Typically this should
...
// startService attempts to Start the Sedrad Service.
