...
type GetBlockTemplateRequestMessage struct {
	...
	// Which sedra address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether sedrad thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when sedrad is not synced.
	// That is because when sedrad isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this sedrad initiated the connection
	...
	// The timestamp of when this peer connected to this sedrad
