...
type P2P_MessageStreamClient interface {
	Send(*SedradMessage) error
	Recv() (*SedradMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *SedradMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*SedradMessage, error) {
	m := new(SedradMessage)
...
func (x *p2PMessageStreamServer) Send(m *SedradMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*SedradMessage, error) {
	m := new(SedradMessage)
...
func (x *rPCMessageStreamClient) Send(m *SedradMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*SedradMessage, error) {
	m := new(SedradMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *SedradMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*SedradMessage, error) {
	m := new(SedradMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
